...
<template>
  ...
  <div :class="['relative p-4 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex gap-10 items-center justify-center', props.isMobile ? 'flex-col' : 'flex-row pr-14']">
    <div class="text-white z-10 max-w-xl text-base text-justify">
      ...
      <p>
        “开往”是一个连接独立网站的友链项目，通过随机跳转的方式，让访客在不同站点之间自由穿梭，像搭乘一列没有终点的列车，在网络世界中不断发现新的内容与创作者。它致力于让传统友链“活跃”起来，让网站之间形成连接与流动，共同构建一个更加开放、多元的互联网环境
        ￼。
      </p>
    </div>
    <div class="relative">
      <div class="absolute w-full h-full blur-[80px] rounded-full bg-[linear-gradient(-45deg,#a1ccce_50%,#faf7f0_50%)]"></div>
