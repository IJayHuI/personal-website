<script setup lang="ts">
  ...
  import JayFooter from '../../components/common/JayFooter.vue'
  import JayArticleList from '../../components/blog/JayArticleList.vue'
...
<template>
  ...
  <n-config-provider v-else :theme-overrides="general.isDark ? blogTheme.dark.mobile : blogTheme.light.mobile">
    <n-layout position="absolute">
      ...
      <n-layout-footer class="flex gap-1 justify-center mb-4"><jay-footer :app-version="appVersion" /></n-layout-footer>
